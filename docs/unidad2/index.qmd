...
title-slide-attributes:
  data-background-image: ../assets/img/fondo3.jpg
...
Film etnográfico distribuido por el Film Study Center de Harvard. 73 minutos grabados en un campamento ganadero de Sudán del Sur.
...
::: {.column width="50%" .fragment .fade-up}
Análisis del conflicto armado en Sudán y sus dimensiones regionales e internacionales.
...
::: {.column width="50%" .fragment .fade-up}
Reflexión sobre la posición de Sudán en el mapa geopolítico contemporáneo.
...
::: {.column width="50%" .fragment .fade-up}
Análisis del rol de los Emiratos Árabes Unidos en el conflicto sudanés y sus intereses en la región.
